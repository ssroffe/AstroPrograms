...
tls.plotchains(sampler,4,"OrbitalFits/"+wdName,"chains.pdf")
...
plt.savefig("OrbitalFits/"+wdName+"_time.pdf")
...
plt.savefig("OrbitalFits/"+wdName+"_num.pdf")
...
plt.savefig("OrbitalFits/"+wdName+"_time_zoomed.pdf")
